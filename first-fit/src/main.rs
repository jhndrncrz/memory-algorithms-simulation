...
fn main() {
        ...
        || number_of_allocated_partitions != 0
    {
            ...
            || (jobs_waiting_queue.is_empty() && jobs_primary_queue.is_empty())
        {
            ...
            for partition_index in 0..number_of_partitions {
                if partitions_occupied[partition_index] != 0.0 {
                    ...
                    if partitions_to_deallocate.contains(&partition_index) {
            ...
            partitions_to_deallocate.sort();
            for partition_index in partitions_to_deallocate {
        ...
        if !jobs_primary_queue.is_empty() {
            ...
            for partition_index in 0..number_of_partitions {
                let partition_name = &partitions_name[partition_index];
                ...
                partitions_is_currently_allocated[partition_index] = true;
                partitions_occupier[partition_index] = job_name.clone();
                partitions_occupied[partition_index] = job_size;
                partitions_unoccupied[partition_index] =
                    partitions_capacity[partition_index] - job_size;
